...
public class ConstantineEIP2537G1MsmTest {
    ...
    public static Iterable<String[]> parameters() throws IOException {
        return CharStreams.readLines(
                        new InputStreamReader(
                                ConstantineEIP2537G1MsmTest.class.getResourceAsStream("/g1_multiexp.csv"), UTF_8))
                .stream()
    ...
    public void shouldCalculate() {
        ...
        int status = LibConstantineEIP2537.bls12381_g1msm(result, result.length, inputBytes, inputBytes.length);
