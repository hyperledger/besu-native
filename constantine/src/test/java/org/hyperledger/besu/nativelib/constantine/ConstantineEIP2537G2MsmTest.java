...
public class ConstantineEIP2537G2MsmTest {
    ...
    public static Iterable<String[]> parameters() throws IOException {
        return CharStreams.readLines(
                        new InputStreamReader(
                                ConstantineEIP2537G2MsmTest.class.getResourceAsStream("/g2_multiexp.csv"), UTF_8))
                .stream()
    ...
    public void shouldCalculate() {
        ...
        int status = LibConstantineEIP2537.bls12381_g2msm(result, result.length, inputBytes, inputBytes.length);
