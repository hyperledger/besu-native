...
public class ConstantineEIP2537G1MulTest {
    ...
    public static Iterable<String[]> parameters() throws IOException {
        return CharStreams.readLines(
                        new InputStreamReader(
                                ConstantineEIP2537G1MulTest.class.getResourceAsStream("/g1_mul.csv"), UTF_8))
                .stream()
    ...
    public void shouldCalculate() {
        ...
        int status = LibConstantineEIP2537.bls12381_g1mul(result, result.length, inputBytes, inputBytes.length);
