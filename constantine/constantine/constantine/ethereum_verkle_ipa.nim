...
func serialize*(dst: var EthVerkleIpaProofBytes,
                ...
                ): cttEthVerkleIpaStatus {.discardable, libPrefix: prefix_ffi.} =
...
func deserialize*(dst: var EthVerkleIpaProof,
                  src: EthVerkleIpaProofBytes): cttEthVerkleIpaStatus {.discardable, libPrefix: prefix_ffi.} =
...
func map_to_base_field*(dst: var Fp[Banderwagon],p: EC_TwEdw[Fp[Banderwagon]]) {.discardable, libPrefix: prefix_ffi.} =
...
func map_to_scalar_field*(res: var Fr[Banderwagon], p: EC_TwEdw[Fp[Banderwagon]]): bool {.discardable, libPrefix: prefix_ffi.} =
...
func batch_map_to_scalar_field*(
      ...
      points: openArray[EC_TwEdw[Fp[Banderwagon]]]): bool {.discardable, noinline, libPrefix: prefix_ffi.} =
...
func commit*(
      crs: PolynomialEval[EthVerkleDomain, EC_TwEdw_Aff[Fp[Banderwagon]]],
      r: var EC_TwEdw[Fp[Banderwagon]], 
      poly: PolynomialEval[256, Fr[Banderwagon]]) {.libPrefix: prefix_ffi.} =
...
func prove*(
      ...
      poly: PolynomialEval[256, Fr[Banderwagon]], 
...
func multi_prove*(
      ...
      opening_challenges_in_domain: openArray[SomeUnsignedInt]) {.libPrefix: prefix_ffi.} =
