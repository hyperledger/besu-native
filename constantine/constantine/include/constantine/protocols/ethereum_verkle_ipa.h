...
extern "C"
{
  ...
  ctt_eth_verkle_ipa_status ctt_eth_verkle_ipa_serialize(ctt_eth_verkle_ipa_proof_bytes *dst, const ctt_eth_verkle_ipa_proof_prj *src) __attribute__((warn_unused_result));
  ctt_eth_verkle_ipa_status ctt_eth_verkle_ipa_deserialize(ctt_eth_verkle_ipa_proof_aff *src, const ctt_eth_verkle_ipa_proof_bytes *dst) __attribute__((warn_unused_result));
  ctt_eth_verkle_ipa_status ctt_eth_verkle_ipa_deserialize(ctt_eth_verkle_ipa_proof_prj *src, const ctt_eth_verkle_ipa_proof_bytes *dst) __attribute__((warn_unused_result));
  ctt_eth_verkle_ipa_status ctt_eth_verkle_ipa_serialize(ctt_eth_verkle_ipa_multi_proof_bytes *dst, const ctt_eth_verkle_ipa_multi_proof_aff *src) __attribute__((warn_unused_result));
  ctt_eth_verkle_ipa_status ctt_eth_verkle_ipa_serialize(ctt_eth_verkle_ipa_multi_proof_bytes *dst, const ctt_eth_verkle_ipa_multi_proof_prj *src) __attribute__((warn_unused_result));
  ctt_eth_verkle_ipa_status ctt_eth_verkle_ipa_deserialize(ctt_eth_verkle_ipa_multi_proof_aff *src, const ctt_eth_verkle_ipa_multi_proof_bytes *dst) __attribute__((warn_unused_result));
  ctt_eth_verkle_ipa_status ctt_eth_verkle_ipa_deserialize(ctt_eth_verkle_ipa_multi_proof_prj *src, const ctt_eth_verkle_ipa_multi_proof_bytes *dst) __attribute__((warn_unused_result));
  void ctt_eth_verkle_ipa_map_to_base_field(banderwagon_fp *dst, const banderwagon_ec_aff *p) __attribute__((warn_unused_result));
  void ctt_eth_verkle_ipa_map_to_base_field(banderwagon_fp *dst, const banderwagon_ec_prj *p) __attribute__((warn_unused_result));
  bool ctt_eth_verkle_ipa_map_to_scalar_field(banderwagon_fr *res, const banderwagon_ec_aff *p) __attribute__((warn_unused_result));
  bool ctt_eth_verkle_ipa_map_to_scalar_field(banderwagon_fr *res, const banderwagon_ec_prj *p) __attribute__((warn_unused_result));
  bool ctt_eth_verkle_ipa_batch_map_to_scalar_field(banderwagon_fr res[], const banderwagon_ec_aff points[], size_t len) __attribute__((warn_unused_result));
  bool ctt_eth_verkle_ipa_batch_map_to_scalar_field(banderwagon_fr res[], const banderwagon_ec_prj points[], size_t len) __attribute__((warn_unused_result));
  ...
  void ctt_eth_verkle_ipa_commit(const ctt_eth_verkle_ipa_polynomial_eval_crs *crs, banderwagon_ec_prj res, const ctt_eth_verkle_ipa_polynomial_eval_poly *poly) __attribute__((warn_unused_result));
