...
extern "C"
{
  ...
  void ctt_eth_verkle_ipa_commit_aff(const ctt_eth_verkle_ipa_polynomial_eval_crs *crs, banderwagon_ec_aff res, const ctt_eth_verkle_ipa_polynomial_eval_poly *poly) __attribute__((warn_unused_result));
