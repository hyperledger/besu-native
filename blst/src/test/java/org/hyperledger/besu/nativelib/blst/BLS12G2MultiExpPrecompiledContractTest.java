...
public class BLS12G2MultiExpPrecompiledContractTest {
  ...
  public static Iterable<String[]> parameters() throws IOException {
    return CharStreams.readLines(
            new InputStreamReader(
                BLS12G2MultiExpPrecompiledContractTest.class.getResourceAsStream("g2_multiexp.csv"), UTF_8))
        .stream()
  ...
  public void shouldCalculate() {
    ...
    for(int i = 0; i < 100; i++) {
      res = Bls12381.g2MultiExpr(testInput);
    }

    System.err.println("time taken for 100x blst G2MultiExp: " + timer);
