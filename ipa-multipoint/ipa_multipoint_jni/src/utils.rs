...
pub fn jobjectarray_to_vec<T, F>(env: &JNIEnv, array: jobjectArray, mut converter: F) -> Option<Vec<T>>
where
...
pub fn get_optional_array(env: &JNIEnv, array: jobjectArray, index: i32) -> Option<Option<[u8; 32]>> {
